...
class appProdProjectContainer extends Container
{
    public function __construct()
    {
        ...
        $this->methodMap = array(
            'acard.frontend.action_listener' => 'getAcard_Frontend_ActionListenerService',
    ...
    protected function getAcard_Frontend_ActionListenerService()
    {
        return $this->services['acard.frontend.action_listener'] = new \Acard\FrontendBundle\EventListener\ControllerEventListener();
    }
    protected function getAnnotationReaderService()
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/home/projects/www/polpharma-cisnienie-na-zycie/app/cache/prod/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/home/projects/www/polpharma-cisnienie-na-zycie/app/cache/prod/assetic/config'), false)));
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/home/projects/www/polpharma-cisnienie-na-zycie/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
        return $instance;
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/home/projects/www/polpharma-cisnienie-na-zycie/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => 3306, 'dbname' => 'polpharma_cnz', 'user' => 'polpharma_cnz', 'password' => 'ea5501', 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_9ec2905861bcdcc258b5dc52f852ba0d61c782303401e2bbba500e296bf24e0b');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_9ec2905861bcdcc258b5dc52f852ba0d61c782303401e2bbba500e296bf24e0b');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_9ec2905861bcdcc258b5dc52f852ba0d61c782303401e2bbba500e296bf24e0b');
        $d = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array('/home/projects/www/polpharma-cisnienie-na-zycie/src/Acard/FrontendBundle/Resources/config/doctrine' => 'Acard\\FrontendBundle\\Entity', '/home/projects/www/polpharma-cisnienie-na-zycie/src/Acard/BackendBundle/Resources/config/doctrine' => 'Acard\\BackendBundle\\Entity'));
        $d->setGlobalBasename('mapping');
        $e = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array('/home/projects/www/polpharma-cisnienie-na-zycie/vendor/friendsofsymfony/user-bundle/FOS/UserBundle/Resources/config/doctrine' => 'FOS\\UserBundle\\Entity'));
        $e->setGlobalBasename('mapping');
        $f = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $f->addDriver($d, 'Acard\\FrontendBundle\\Entity');
        $f->addDriver($d, 'Acard\\BackendBundle\\Entity');
        $f->addDriver($e, 'FOS\\UserBundle\\Entity');
        $f->addDriver(new \Doctrine\ORM\Mapping\Driver\XmlDriver(new \Doctrine\Common\Persistence\Mapping\Driver\SymfonyFileLocator(array('/home/projects/www/polpharma-cisnienie-na-zycie/vendor/friendsofsymfony/user-bundle/FOS/UserBundle/Resources/config/doctrine/model' => 'FOS\\UserBundle\\Model'), '.orm.xml')), 'FOS\\UserBundle\\Model');
        $g = new \Doctrine\ORM\Configuration();
        $g->setEntityNamespaces(array('AcardFrontendBundle' => 'Acard\\FrontendBundle\\Entity', 'AcardBackendBundle' => 'Acard\\BackendBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity'));
        $g->setMetadataCacheImpl($a);
        $g->setQueryCacheImpl($b);
        $g->setResultCacheImpl($c);
        $g->setMetadataDriverImpl($f);
        $g->setProxyDir('/home/projects/www/polpharma-cisnienie-na-zycie/app/cache/prod/doctrine/orm/Proxies');
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListenerService('kernel.controller', array(0 => 'acard.frontend.action_listener', 1 => 'onKernelController'), 0);
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/home/projects/www/polpharma-cisnienie-na-zycie/app/Resources');
    }
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Acard\\BackendBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Acard\\BackendBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Acard\\BackendBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Acard\\BackendBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Acard\\BackendBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('/home/projects/www/polpharma-cisnienie-na-zycie/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/home/projects/www/polpharma-cisnienie-na-zycie/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/home/projects/www/polpharma-cisnienie-na-zycie/app/cache/prod/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/home/projects/www/polpharma-cisnienie-na-zycie/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/home/projects/www/polpharma-cisnienie-na-zycie/app/cache/prod/translations', 'debug' => false));
    }
    protected function getTwigService()
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/home/projects/www/polpharma-cisnienie-na-zycie/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
        $instance->addExtension(new \Symfony\Bundle\SecurityBundle\Twig\Extension\LogoutUrlExtension($this->get('templating.helper.logout_url')));
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\SecurityExtension($this->get('security.context', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\TranslationExtension($this->get('translator')));
        $instance->addExtension(new \Symfony\Bundle\TwigBundle\Extension\AssetsExtension($this));
        $instance->addExtension(new \Symfony\Bundle\TwigBundle\Extension\ActionsExtension($this));
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/home/projects/www/polpharma-cisnienie-na-zycie/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/home/projects/www/polpharma-cisnienie-na-zycie/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/home/projects/www/polpharma-cisnienie-na-zycie/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/home/projects/www/polpharma-cisnienie-na-zycie/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/home/projects/www/polpharma-cisnienie-na-zycie/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/home/projects/www/polpharma-cisnienie-na-zycie/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/home/projects/www/polpharma-cisnienie-na-zycie/src/Acard/FrontendBundle/Resources/views', 'AcardFrontend');
        $instance->addPath('/home/projects/www/polpharma-cisnienie-na-zycie/src/Acard/BackendBundle/Resources/views', 'AcardBackend');
        $instance->addPath('/home/projects/www/polpharma-cisnienie-na-zycie/vendor/friendsofsymfony/user-bundle/FOS/UserBundle/Resources/views', 'FOSUser');
        $instance->addPath('/home/projects/www/polpharma-cisnienie-na-zycie/app/Resources/views');
        $instance->addPath('/home/projects/www/polpharma-cisnienie-na-zycie/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
        return $instance;
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('28e6ff09c2edaf499fbaf92f4933acc2');
    }
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/home/projects/www/polpharma-cisnienie-na-zycie/app/../web', false);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/home/projects/www/polpharma-cisnienie-na-zycie/app/cache/prod');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/home/projects/www/polpharma-cisnienie-na-zycie/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml', 1 => '/home/projects/www/polpharma-cisnienie-na-zycie/vendor/friendsofsymfony/user-bundle/FOS/UserBundle/Resources/config/validation.xml', 2 => '/home/projects/www/polpharma-cisnienie-na-zycie/vendor/friendsofsymfony/user-bundle/FOS/UserBundle/Resources/config/validation/orm.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array(0 => '/home/projects/www/polpharma-cisnienie-na-zycie/src/Acard/FrontendBundle/Resources/config/validation.yml')))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/home/projects/www/polpharma-cisnienie-na-zycie/app',
            'kernel.environment' => 'prod',
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/home/projects/www/polpharma-cisnienie-na-zycie/app/cache/prod',
            'kernel.logs_dir' => '/home/projects/www/polpharma-cisnienie-na-zycie/app/logs',
            'kernel.bundles' => array(
                ...
                'AcardFrontendBundle' => 'Acard\\FrontendBundle\\AcardFrontendBundle',
                'DoctrineFixturesBundle' => 'Doctrine\\Bundle\\FixturesBundle\\DoctrineFixturesBundle',
                'AcardBackendBundle' => 'Acard\\BackendBundle\\AcardBackendBundle',
            ...
            'database_port' => 3306,
            'database_name' => 'polpharma_cnz',
            'database_user' => 'polpharma_cnz',
            'database_password' => 'ea5501',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'locale' => 'pl',
            'secret' => '28e6ff09c2edaf499fbaf92f4933acc2',
            ...
            'kernel.secret' => '28e6ff09c2edaf499fbaf92f4933acc2',
            ...
            'session.save_path' => '/home/projects/www/polpharma-cisnienie-na-zycie/app/cache/prod/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => '/home/projects/www/polpharma-cisnienie-na-zycie/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml',
                1 => '/home/projects/www/polpharma-cisnienie-na-zycie/vendor/friendsofsymfony/user-bundle/FOS/UserBundle/Resources/config/validation.xml',
                2 => '/home/projects/www/polpharma-cisnienie-na-zycie/vendor/friendsofsymfony/user-bundle/FOS/UserBundle/Resources/config/validation/orm.xml',
            ),
            'validator.mapping.loader.yaml_files_loader.mapping_files' => array(
                0 => '/home/projects/www/polpharma-cisnienie-na-zycie/src/Acard/FrontendBundle/Resources/config/validation.yml',
            ),
            ...
            'router.resource' => '/home/projects/www/polpharma-cisnienie-na-zycie/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/home/projects/www/polpharma-cisnienie-na-zycie/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => '/home/projects/www/polpharma-cisnienie-na-zycie/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/home/projects/www/polpharma-cisnienie-na-zycie/app/cache/prod/assetic',
            ...
            'assetic.read_from' => '/home/projects/www/polpharma-cisnienie-na-zycie/app/../web',
            'assetic.write_to' => '/home/projects/www/polpharma-cisnienie-na-zycie/app/../web',
            ...
            'doctrine.dbal.events.mysql_session_init.class' => 'Doctrine\\DBAL\\Map\\Listeners\\MysqlSessionInit',
            'doctrine.dbal.events.oracle_session_init.class' => 'Doctrine\\DBAL\\Map\\Listeners\\OracleSessionInit',
            ...
            'doctrine.orm.proxy_dir' => '/home/projects/www/polpharma-cisnienie-na-zycie/app/cache/prod/doctrine/orm/Proxies',
            ...
            'fos_user.model.user.class' => 'Acard\\BackendBundle\\Entity\\User',
